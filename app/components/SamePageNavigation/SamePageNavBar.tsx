...
const SamePageNavBar = ({ sections } : SamePageNavBarProps) => {
    return (
        <nav className="sticky top-0 w-full bg-black text-white font-Aldrich xl:text-xl lg:text-l z-50 top-28">
            ...
            <Link href={'#'+section} className="hover:text-green">{section}</Link>
        ))}
            </div>
            </div>
        </nav>
